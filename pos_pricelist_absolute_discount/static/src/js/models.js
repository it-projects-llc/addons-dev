...
////                        pricelist_id = order.active_price_list[0];
////                    } else {
...
//            // we applied the default price list
//            if (this.line_pricelist_id) {
//                all_rules = this.pos.pricelist_engine.get_all_rules_by_pricelist_id(this.line_pricelist_id);
//            }
...
//            }
//            this.line_pricelist_id = this.pos.config.pricelist_id[0];
//            this.set_discount(0);
//            this.check_pricelist();
//            this.line_pricelist_id = false;
//        },
//    });
