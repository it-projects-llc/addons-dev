...
* Add hw_printer_network module to server wide modules (set server_wide_modules in config file or specify --load parameter in run command): e.g. ./odoo-bin --load hw_printer_network
