...
class IrActionsReport(models.Model):
    ...
    webkit_header = fields.Many2one("ir.header_webkit", string='Webkit Header',
                                    company_dependent=True, help="The header linked to the report", required=True)
    ...
    precise_mode = fields.Boolean('Precise Mode', help="This mode allow more precise element position "
                                                       "as each object is printed on a separate HTML but "
                                                       "memory and disk usage are wider.")
    # # TODO:
    # @api.model_cr
