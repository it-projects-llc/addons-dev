...
class ReportTableQrCode(models.AbstractModel):
    ...
    def get_report_values(self, docids, data=None):
        access_token = self.env['ir.config_parameter'].sudo().get_miniprogram_access_token()
        ...
        docs = [{'name': r.name, 'qr_code': r.get_miniprogram_qr_code(access_token)} for r in records]
