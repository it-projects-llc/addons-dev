odoo.define('mail_private.mail_private', function (require) {
"use strict";
    
    var mail_base = require('mail_base.base');
    var chatter = require('mail.Chatter');
    var ChatterComposer = require('mail_private.ChatterComposer');
    
    chatter.include({
        init: function() {
            this._super.apply(this, arguments);
            this.events['click .o_chatter_button_new_internal_message'] = 'on_open_composer_new_internal_message';
        },
        on_open_composer_new_internal_message: function(){
            this.open_composer({is_internal: true});
        },
        open_composer: function (options) {
            ...
            this.composer = new ChatterComposer(this, this.thread_dataset, {
                ...
                is_internal: options && options.is_internal,
