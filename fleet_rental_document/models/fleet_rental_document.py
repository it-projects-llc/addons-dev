...
class FleetRentalDocument(models.Model):
    ...
    advanced_deposit = fields.Float(string='Total Rent Price', compute="_compute_advanced_deposit", store=True, digits_compute=dp.get_precision('Product Price'), readonly=True)
